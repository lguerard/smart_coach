...
FR_SYSTEM_PROMPT = (
    ...
    "ne couvre tout simplement pas cette journee : dis-le tel quel "
    "(les donnees manquent, ce n'est pas un jeune), n'en tire AUCUNE "
    "conclusion sur ce qui a ete mange, et passe au budget du jour. "
    ...
    "transmettre les repas a temps et l'eau en retard), ne cite "
    "AUCUN chiffre d'eau pour hier ni aucun manque d'hydratation -- "
    "traite juste la nourriture normalement et laisse l'eau de cote "
    "pour cette ligne. Si "
...
EN_SYSTEM_PROMPT = (
    ...
    "simply does not cover that day: say so plainly (the data is "
    "missing, this was not a fast), draw NO conclusion about what "
    "was eaten, and move on to today's budget. "
    ...
    "meals through on time and water a day late), quote NO water "
    "figure for yesterday and no hydration shortfall -- just cover "
    "food normally and leave water out of this line. If "
